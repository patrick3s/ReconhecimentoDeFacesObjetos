...
for file in glob.glob(os.path.join(path+"fotos/treinamento","*.jpg")):
    img = cv2.imread(file)
...
np.save(path+"recursos/descritores_rn.npy",describe_faces)
with open(path+"recursos/indices_rn.pickle",'wb') as f:
    pk.dump(indices,f)
